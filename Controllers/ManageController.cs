...
namespace jcamacho_budgeter1.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ChangeUserName(ResetNameViewModel model)

        {
            ...
            {
                userOriginal.Email = model.Email;
            }

            if ((model.FirstName != null && model.FirstName != ""))
            {
                userOriginal.FirstName = model.FirstName;
            }

            if ((model.LastName != null) && (model.LastName != ""))
            {
                userOriginal.LastName = model.LastName;
            }

            if ((model.DisplayName != null) && (model.DisplayName != ""))
            {
                userOriginal.DisplayName = model.DisplayName;
            }

            if ((model.PhoneNumber != null) && (model.PhoneNumber != ""))
            {
                userOriginal.PhoneNumber = model.PhoneNumber;
            }
